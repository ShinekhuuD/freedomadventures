...
function get_custom_page_meta_fields() {
	...
	$cmsmasters_global_layout = (isset($cmsmasters_option['travel-time' . '_layout']) && $cmsmasters_option['travel-time' . '_layout'] !== '') ? $cmsmasters_option['travel-time' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['travel-time' . '_header_overlaps']) && $cmsmasters_option['travel-time' . '_header_overlaps'] !== '') ? (($cmsmasters_option['travel-time' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'travel-time'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'travel-time'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'travel-time'), 
