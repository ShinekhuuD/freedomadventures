...
add_action('admin_menu', 'travel_time_add_menu');
add_action('admin_init', 'travel_time_register_settings');
...
function travel_time_get_settings() {
	$output = array();
	
	
	$page = travel_time_get_admin_page();
	...
	case 'cmsmasters-settings':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'travel-time';
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'travel-time');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', travel_time_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', travel_time_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', travel_time_options_general_tabs());
	...
	case 'cmsmasters-settings' . '-font':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'travel-time' . '_font';
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'travel-time');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', travel_time_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', travel_time_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', travel_time_options_font_tabs());
	...
	case 'cmsmasters-settings' . '-color':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'travel-time' . '_color';
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'travel-time');
		$cmsmasters_page_sections = travel_time_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', travel_time_options_color_fields(), $tab);
		$cmsmasters_page_tabs = travel_time_options_color_tabs();
	...
	case 'cmsmasters-settings' . '-element':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'travel-time' . '_element';
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'travel-time');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', travel_time_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', travel_time_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', travel_time_options_element_tabs());
	...
	case 'cmsmasters-settings' . '-single':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'travel-time' . '_single';
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'travel-time');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', travel_time_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', travel_time_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', travel_time_options_single_tabs());
	...
	case 'cmsmasters-settings' . '-demo':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'travel-time' . '_demo';
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'travel-time');
		$cmsmasters_page_sections = travel_time_options_demo_sections();
		$cmsmasters_page_fields = travel_time_options_demo_fields();
		$cmsmasters_page_tabs = travel_time_options_demo_tabs();
...
function travel_time_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'travel-time'), 
		'desc' => 		esc_html__('This is a default description.', 'travel-time'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function travel_time_register_settings() {
	$settings_output = travel_time_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'travel_time_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'travel_time_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			travel_time_create_settings_field($option);
		}
	}
...
function travel_time_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 	esc_html__('Do you realy want to remove this sidebar?', 'travel-time'), 
		'find' => 				esc_attr__('Find icons', 'travel-time'), 
		'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'travel-time'), 
		'theme_uri' => 			get_template_directory_uri(), 
		'shortname' => 			'travel-time', 
		'done' => 				esc_html__('All theme settings were imported successfully.', 'travel-time'), 
		'fail' => 				esc_html__("Error on page!!!\nPlease reload page and try again.", 'travel-time'), 
...
function travel_time_add_menu() {
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'travel-time'), 
		esc_attr__('Theme Settings', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings', 
		'travel_time_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme General Settings', 'travel-time'), 
		esc_attr__('General', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings', 
		'travel_time_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'travel_time_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Fonts Settings', 'travel-time'), 
		esc_attr__('Fonts', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings' . '-font', 
		'travel_time_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'travel_time_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Color Schemes', 'travel-time'), 
		esc_attr__('Colors', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings' . '-color', 
		'travel_time_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'travel_time_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Elements Settings', 'travel-time'), 
		esc_attr__('Elements', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings' . '-element', 
		'travel_time_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'travel_time_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Single Posts Settings', 'travel-time'), 
		esc_attr__('Single Posts', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings' . '-single', 
		'travel_time_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'travel_time_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Settings Import/Export', 'travel-time'), 
		esc_attr__('Import/Export', 'travel-time'), 
		'manage_options', 
		'cmsmasters-settings' . '-demo', 
		'travel_time_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'travel_time_settings_scripts');
}


function travel_time_section_fn($desc) {
	$tab = travel_time_get_the_tab();
...
function travel_time_settings_page_fn() {
	$settings_output = travel_time_get_settings();
	$current_tab = travel_time_get_the_tab();
	
	echo '<div class="wrap">';
	
	travel_time_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'travel-time') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'travel-time') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'travel-time') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function travel_time_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'travel-time') . '" data-title="' . esc_attr__('Choose Image', 'travel-time') . '" data-button="' . esc_attr__('Insert Image', 'travel-time') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" alt="" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'travel-time') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (travel_time_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'travel-time') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'travel-time') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'travel-time') . ' <em>(' . esc_html__('in pixels', 'travel-time') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'travel-time') . ' <em>(' . esc_html__('in pixels', 'travel-time') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'travel-time') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'travel-time') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (travel_time_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'travel-time') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (travel_time_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'travel-time') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'travel-time') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'travel-time') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'travel-time') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'travel-time') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'travel-time') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'travel-time') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'travel-time') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'travel-time') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'travel-time') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'travel-time') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'travel-time') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'travel-time') . '"></a> ' . 
...
function travel_time_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'travel-time');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						'travel-time' . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'travel-time'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'travel-time');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						$option['id'],
						'travel-time' . '_txt_multinumeric_error',
						esc_html__('Expecting comma separated numeric values! Please fix.','travel-time'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'travel-time');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'travel-time');
				}
				
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						$option['id'],
						'travel-time' . '_txt_email_error',
						esc_html__('Please enter a valid email address.', 'travel-time'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'travel-time');
...
function theme_admin_bar_render() {
	...
	$wp_admin_bar->add_menu(array( 
		'id' => 'travel-time' . '_options', 
		'title' => esc_attr__('Theme Settings', 'travel-time'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'travel-time' . '_options', 
		'id' => 'travel-time' . '_theme_settings', 
		'title' => esc_attr__('General', 'travel-time'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'travel-time' . '_options', 
		'id' => 'travel-time' . '_theme_settings_font', 
		'title' => esc_attr__('Fonts', 'travel-time'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-font')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'travel-time' . '_options', 
		'id' => 'travel-time' . '_theme_settings_color', 
		'title' => esc_attr__('Colors', 'travel-time'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-color')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'travel-time' . '_options', 
		'id' => 'travel-time' . '_theme_settings_element', 
		'title' => esc_attr__('Elements', 'travel-time'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings-element')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => 'travel-time' . '_options', 
		'id' => 'travel-time' . '_theme_settings_single', 
		'title' => esc_attr__('Single', 'travel-time'), 
...
function travel_time_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function travel_time_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			travel_time_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				travel_time_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'travel_time_admin_msgs');


function travel_time_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_general', 
			travel_time_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_bg', 
			travel_time_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_header', 
			travel_time_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_content', 
			travel_time_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_footer', 
			travel_time_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_font_content', 
			travel_time_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_font_link', 
			travel_time_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_font_nav', 
			travel_time_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_font_heading', 
			travel_time_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_font_other', 
			travel_time_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_element_sidebar', 
			travel_time_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_element_icon', 
			travel_time_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_element_lightbox', 
			travel_time_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_element_sitemap', 
			travel_time_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_element_error', 
			travel_time_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_element_code', 
			travel_time_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			travel_time_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_single_project', 
			travel_time_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_single_profile', 
			travel_time_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . 'travel-time' . '_single_campaign', 
			travel_time_options_single_fields('campaign') 
		) 
	);
	...
	foreach (travel_time_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			'cmsmasters_options_' . 'travel-time' . '_color_' . $key, 
			travel_time_options_color_fields($key) 
		));
	}
		...
		if ($cmsmasters_option_name[1] !== '') {
			foreach ($cmsmasters_option_name[1] as $selected_option) {
				if ( 
					...
					$selected_option['id'] !== 'travel-time' . '_social_icons' 
				) {
...
function travel_time_get_global_options() {
	...
	foreach (travel_time_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, 'cmsmasters_options_' . 'travel-time' . '_color_' . $key);
	}
