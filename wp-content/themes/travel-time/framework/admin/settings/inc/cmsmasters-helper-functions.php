...
function travel_time_get_admin_page() {
	global $pagenow;
...
function travel_time_default_tab() {
	$current_page = travel_time_get_admin_page();
...
function travel_time_get_the_tab() {
	global $pagenow;
	
	$default_tab = travel_time_default_tab();
...
function travel_time_settings_page_header() {
