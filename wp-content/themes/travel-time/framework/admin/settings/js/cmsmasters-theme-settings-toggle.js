...
(function ($) { 
	...
	if ($('#' + cmsmasters_settings.shortname + '_header_top_line').is(':not(:checked)')) {
		...
		$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but').parents('tr').hide();
	...
	if ($('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but').is(':not(:checked)')) {
		$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but_text').parents('tr').hide();
	}
	...
	if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'default') {
		...
		$('#' + cmsmasters_settings.shortname + '_header_donations_but').parents('tr').hide();
		$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').hide();
	...
	if ($('#' + cmsmasters_settings.shortname + '_header_donations_but').is(':not(:checked)')) {
		$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').hide();
	}
	...
	$('#' + cmsmasters_settings.shortname + '_header_top_line').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_top_line').is(':checked')) {
			...
			$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but').parents('tr').show();
			...
			if ($('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but').is(':checked')) {
				$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but_text').parents('tr').show();
			} else {
				$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but_text').parents('tr').hide();
			}
		} else {
	...
	$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but').is(':checked')) {
			$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but_text').parents('tr').show();
		} else {
			$('#' + cmsmasters_settings.shortname + '_header_top_line_donations_but_text').parents('tr').hide();
	...
	$('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]').on('change', function () { 
		if ($('input[name*="' + cmsmasters_settings.shortname + '_header_styles"]:checked').val() === 'default') {
			...
			$('#' + cmsmasters_settings.shortname + '_header_bot_height').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_header_search').parents('tr').show();
			$('#' + cmsmasters_settings.shortname + '_header_donations_but').parents('tr').show();
			...
			if ($('#' + cmsmasters_settings.shortname + '_header_donations_but').is(':checked')) {
				$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').show();
			} else {
				$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').hide();
			}
		}
	...
	$('#' + cmsmasters_settings.shortname + '_header_donations_but').on('change', function () { 
		if ($('#' + cmsmasters_settings.shortname + '_header_donations_but').is(':checked')) {
			$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').show();
		} else {
			$('#' + cmsmasters_settings.shortname + '_header_donations_but_text').parents('tr').hide();
	...
	/* Single Posts 'Tour' Tab Fields Load */
	...
	/* Single Posts 'Tour' Tab 'Tour Link' Field Change */
