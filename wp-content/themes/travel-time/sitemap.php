...
if ($cmsmasters_option['travel-time' . '_sitemap_nav']) { 
	echo '<h2>' . esc_html__('Website Pages', 'travel-time') . '</h2>';
...
if ($cmsmasters_option['travel-time' . '_sitemap_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Blog Archives by Categories', 'travel-time') . '</h2>' . 
...
if ($cmsmasters_option['travel-time' . '_sitemap_tags']) {
	$tags = get_tags(array( 
		'orderby' => 'name', 
		'order' => 'DESC' 
	));
	...
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Blog Archives by Tags', 'travel-time') . '</h2>' . 
...
if ($cmsmasters_option['travel-time' . '_sitemap_month']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Blog Archives by Month', 'travel-time') . '</h2>' . 
	'<ul class="cmsmasters_sitemap_archive">';
...
if ($cmsmasters_option['travel-time' . '_sitemap_pj_categs']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Tours Archives by Categories', 'travel-time') . '</h2>' . 
	'<ul class="cmsmasters_sitemap_category">';
...
if ($cmsmasters_option['travel-time' . '_sitemap_pj_tags']) {
	echo '<div class="cmsmasters_divider solid"></div>' . 
	'<h2>' . esc_html__('Tours Archives by Tags', 'travel-time') . '</h2>' . 
	'<ul class="cmsmasters_sitemap_archive">';
