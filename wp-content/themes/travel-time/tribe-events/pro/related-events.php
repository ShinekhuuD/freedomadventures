...
<h6 class="tribe-events-related-events-title"><?php printf( esc_html__( 'Related %s', 'tribe-events-calendar-pro' ), tribe_get_event_label_plural() ); ?></h6>

<ul class="tribe-related-events tribe-clearfix hfeed vcalendar clearfix">
	<?php foreach ( $posts as $post ) : ?>
	<li>
		<?php $thumb = (has_post_thumbnail($post->ID)) ? get_the_post_thumbnail($post->ID, 'cmsmasters-tour-thumb') : '<span class="cmsmasters_events_img_placeholder cmsmasters_theme_icon_image"></span>'; ?>
