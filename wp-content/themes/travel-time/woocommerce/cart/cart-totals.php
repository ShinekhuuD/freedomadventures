...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			...
			<td data-title="<?php esc_html_e( 'Cart Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php elseif ( WC()->cart->needs_shipping() ) : ?>
			...
			<tr class="shipping">
				...
				<td data-title="<?php esc_html_e( 'Shipping and handling', 'woocommerce' ); ?>"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<tr class="order-total">
			...
			<td data-title="<?php esc_html_e( 'Order Total', 'woocommerce' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
